...
/*
 * converts entry type to actual datatype and returns it.
 */
...
/* _int functions are legacy functions compliant only with rev 1.0
 * specification. Intention is to deprecate those and remove them far in the
 * future.
 */
